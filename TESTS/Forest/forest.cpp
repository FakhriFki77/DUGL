...
PDMutex renderMutex = NULL;
PDMutex dataMutex = NULL;
...
void ForestInit() {
    ...
    for (int i=0; i<256; i++) {
        TGround[i].x=-4096+(i&0xf)*512;
        TGround[i].y=TreeYPos;
        TGround[i].z=512.0*(float)(i/16)+100.0;
        TGround[i].width=512;
        TGround[i].height=512;
    }
...
void GroundRectRender(Ground *grnd) {
    ...
    if (grnd->z>20.0+(grnd->height*3)) {
        ...
        TreePts[0].xt=Ground1Surf16->MaxX;
        TreePts[0].yt=Ground1Surf16->MinY;
        TreePts[1].xt=Ground1Surf16->MinX;
        TreePts[1].yt=Ground1Surf16->MinY;
        TreePts[2].xt=Ground1Surf16->MinX;
        TreePts[2].yt=Ground1Surf16->MaxY;
        TreePts[3].xt=Ground1Surf16->MaxX;
        TreePts[3].yt=Ground1Surf16->MaxY;
        ...
        for (int i=0; i<4; i++) {
            ...
            if (TreePts[0].z > 1.0f) {
                ...
                TreePts[0].xt=Ground1Surf16->MaxX;
                TreePts[0].yt=Ground1Surf16->MinY+(int)((float)(i)*tyStep);
                TreePts[1].xt=Ground1Surf16->MinX;
                TreePts[1].yt=TreePts[0].yt;
                TreePts[2].xt=Ground1Surf16->MinX;
                TreePts[2].yt=Ground1Surf16->MinY+(int)((float)(i+1)*tyStep);
                TreePts[3].xt=Ground1Surf16->MaxX;
                TreePts[3].yt=TreePts[2].yt;
...
void RoadRectRender(Road *rd) {
    ...
    if (rd->z>20.0f+(512.0f*3.0f)) {
        ...
        TreePts[0].xt=myAspahlt->MaxX;
        TreePts[0].yt=myAspahlt->MinY;
        TreePts[1].xt=myAspahlt->MinX;
        TreePts[1].yt=myAspahlt->MinY;
        TreePts[2].xt=myAspahlt->MinX;
        TreePts[2].yt=myAspahlt->MaxY;
        TreePts[3].xt=myAspahlt->MaxX;
        TreePts[3].yt=myAspahlt->MaxY;
        ...
        for (int i=0; i<4; i++) {
            ...
            if (TreePts[0].z > 1.0f) {
                ...
                TreePts[0].xt=myAspahlt->MaxX;
                TreePts[0].yt=myAspahlt->MinY+(int)((float)(i)*tyStep);
                TreePts[1].xt=myAspahlt->MinX;
                TreePts[1].yt=TreePts[0].yt;
                TreePts[2].xt=myAspahlt->MinX;
                TreePts[2].yt=myAspahlt->MinY+(int)((float)(i+1)*tyStep);
                TreePts[3].xt=myAspahlt->MaxX;
                TreePts[3].yt=TreePts[2].yt;
...
void PtsRectGenerate(DgSurf *S16, int xRect,
    ...
    TreePts[1].y=yRect;
    TreePts[2].x=x2Rect;
    TreePts[2].y=y2Rect;//*2/3);
    TreePts[3].x=xRect;
    TreePts[3].y=y2Rect;
    if (rev) {
        TreePts[0].xt=S16->MaxX;
        TreePts[0].yt=S16->MinY;
        TreePts[1].xt=S16->MinX;
        TreePts[1].yt=S16->MinY;
        TreePts[2].xt=S16->MinX;
        TreePts[2].yt=S16->MaxY;
        TreePts[3].xt=S16->MaxX;
        TreePts[3].yt=S16->MaxY;
    } else {
        TreePts[0].xt=S16->MinX;
        TreePts[0].yt=S16->MinY;
        TreePts[1].xt=S16->MaxX;
        TreePts[1].yt=S16->MinY;
        TreePts[2].xt=S16->MaxX;
        TreePts[2].yt=S16->MaxY;
        TreePts[3].xt=S16->MinX;
        TreePts[3].yt=S16->MaxY;
    }
}
